  ...
  return (
    <>
      ...
      <div className="flex w-full flex-col items-center justify-center gap-10 py-32">
        ...
        <div className="h-32 w-4/5 rounded-2xl bg-gradient-to-r from-redF to-redT p-[2px] transition-all">
          <div
            className={`flex h-full w-full items-center gap-6 rounded-2xl bg-bg p-4 md:gap-2`}
          ></div>
        </div>
      </div>
